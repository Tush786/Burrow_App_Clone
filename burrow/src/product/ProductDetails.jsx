...
import { singleproduct } from '../redux/User/actions';
...
const ProductDetails = () => {
  ...
  const { productName, description, sellingPrice, retailPrice, imagesurl, colorShema } = product;

  return (
    <section className="text-gray-400 bg-white body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <Box className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded">
            {isLoading ? (
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            {isLoading ? (
              ...
              <>
                <h2 className="text-sm title-font text-gray-500 tracking-widest">{productName}</h2>
              </>
            )}
            <div className="flex mb-4">
              <span className="flex items-center">
                {/* SVG Icons for ratings */}
                {[...Array(5)].map((_, i) => (
                  <svg key={i} fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 text-indigo-400" viewBox="0 0 24 24">
            ...
            <div className="flex">
              {isLoading ? (
                ...
                <>
                  <span className="title-font font-medium text-2xl text-black">${sellingPrice}</span>
